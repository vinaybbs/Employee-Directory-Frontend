...
import {filterjobtitle} from '../../../Apis/Api';
...
function FiteredJobTitleList(): React.ReactElement {
    ...
    useEffect(() => {
        const fetchEmployeeDetails = async () => {
          ...
          try {
            const response = await axios.get<Employee[]>(`${filterjobtitle}/${jobtitle}`,config);
...
export default FiteredJobTitleList;